...
class MyButton extends Frame{
	...
	MyButton(){
		...
		t3.setBounds(200,250,200,40);
		t4.setBounds(200,300,200,40);
		t5.setBounds(200,350,200,40);
		t6.setBounds(200,400,200,40);
		t7.setBounds(200,450,200,40);
